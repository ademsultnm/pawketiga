                ...
                <div class="container-fluid">
                    ...
                    <form action="/edit">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nbi" name="nbi" value="{{ $data->nbi }}"
                                aria-describedby="emailHelp">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="praktikum" name="praktikum" value="{{ %data->praktikum }}"
                                aria-describedby="emailHelp">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="sesi" name="sesi" value="{{ $data->sesi }}"
                                aria-describedby="emailHelp">
                            <div id="emailHelp" class="form-text">Ex: 1-3</div>
                        </div>
                        <!-- end form text field -->
